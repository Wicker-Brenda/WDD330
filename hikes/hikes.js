...
const hikeList = [
  ...
  export default class Hikes {
    constructor(elementId) { 
      this.parentElement = document.getElementById(elementId); //or just 'hikes' elementId again
      
      // we need a back button to return back to the list. This will build it and hide it. When we need it we just need to remove the 'hidden' class
      this.backButton = this.buildBackButton(); // Don't need 'hidden' class if place it inside full view
    }
    // getter function to get all the Hikes. HikeList is not exported, and so it cannot be seen outside of this module. I added this in case I ever need the list of hikes outside of the module. This also sets me up nicely if my data were to move. I can just change this method to the new source and everything will still work if I only access the data through this getter.
    getAllHikes() {
      return hikeList;
    }
    ...
    showHikeList() {
      ...
      //if you put the back button here (instead of showOneHike), it will need to be hidden until on full view page
    ...
    addHikeListener() {
      ...
      // {
      //   children[i].addEventListener('touchend', (event) => this.showOneHike(children[i].myName));
      // }
    }
    buildBackButton() {
  ...
  function renderOneHikeLight(hike) {
    ...
    //item.classList.add('light'); //do I need this?- only for CSS, remove if don't use it
    item.setAttribute('data-name', hike.name); //use to make getting details for a specific hike easier
